...
> = {
  ...
  truck: { label: "Caminhão", icon: Truck, tone: "bg-amber-50 text-amber-700" },
  bus: { label: "Ônibus", icon: Bus, tone: "bg-sky-50 text-sky-700" },
...
export function VehicleTypeIcon({
  ...
  return (
    <span
      className={cn(
        "inline-flex items-center gap-2 rounded-md px-2.5 py-1.5 text-xs font-semibold",
        config.tone,
        className,
      )}
    >
